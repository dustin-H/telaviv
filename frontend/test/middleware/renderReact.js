...
describe('Using the renderReact middleware', () => {
  ...
  it('should render a data component including the correct data for client rendering', () => {
    ...
    expect(req.bauhaus.renderData.content).to.equal('<div data-reactroot="" data-reactid="1" data-react-checksum="213198241"><div data-reactid="2">{&quot;some&quot;:&quot;data&quot;}</div></div>')
  })
  it('should render a data component including the correct data as static markup', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div>{&quot;some&quot;:&quot;data&quot;}</div></div>')
  })
  it('should render a active component including the correct data when the path is matching', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div>true</div></div>')
  })
  it('should render a active component including the correct data when the path is NOT matching', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div>false</div></div>')
  })
  it('should render multiple style components in the correct order #1', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div class="styles-red-0"></div><div class="styles-blue-0"></div></div>')
    expect(req.bauhaus.renderData.styles).to.equal('.styles-red-0{color:red}.styles-blue-0{color:blue}')
  })
  it('should render multiple style components in the correct order #2', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div class="styles-blue-0"></div><div class="styles-red-0"></div></div>')
    expect(req.bauhaus.renderData.styles).to.equal('.styles-red-0{color:red}.styles-blue-0{color:blue}')
  })
  ...
  it('should set the title correctly', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.title).to.equal('SpecialTitle')
  })
  it('should add something to the head correctly', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.head).to.equal('<script>var SpecialScript = 42;</script>')
  })
  it('should render the link component correctly', () => {
    ...
    expect(next).to.have.been.calledOnce
    expect(next.args[0].length).to.equal(0)
    expect(req.bauhaus.renderData.content).to.equal('<div><div><a class="" href="/link/to">Link1</a><a class="" href="/not/link/to">Link2</a><a class="link link-active" href="/link/to">Link3</a><a class="link" href="/not/link/to">Link4</a><a style="color:blue;" class="" href="/link/to">Link5</a><a style="color:red;" class="" href="/not/link/to">Link6</a><a class="" href="/link/to">Link7</a><a class="" href="/not/link/to">Link8</a><a class="link-active" href="/link/to">Link9</a><a class="" href="/not/link/to">Link10</a></div></div>')
  })
})
